                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="card-box">
                                   <h4 class="header-title m-t-0 m-b-30">Contact Us</h4>
...
?>
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                              <input type="text" name="phonenum" class=" form-control" required= "true" value="<?php  echo $row['MobileNumber'];?>" maxlength="10">
                                        </div>
                                    </div>
                                    <?php } ?>
                                    <div class="form-group row">
